...
import * as adjectives from './txt/adjectives'
import * as secretadjectives from './txt/secretadjectives'
import * as adverbs from './txt/adverbs'
import * as names from './txt/names'
import { jobs, relations, namers} from './txt/people'
import * as animals from './txt/animals'
import * as owners from './txt/owners'
import * as places from './txt/places'
import * as harms from './txt/harms'
import { provenance, provenanceFunctions } from './txt/provenance'
import { conditions, gemverbs } from './txt/conditions'
